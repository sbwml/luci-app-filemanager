...
var sortField = 'type'; // Field to sort files by
...
.directory-link {
    ...
    color: #3a84ff !important; /* DeepSkyBlue */
    font-weight: bold;
}
...
return view.extend({
	 ...
	 *
	 * @param {string} tab - The identifier of the tab to switch to ('filemanager', 'editor', 'settings').
	 */
